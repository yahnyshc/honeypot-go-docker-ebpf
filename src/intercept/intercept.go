...
import (
	...
	"honeypot-go-docker-ebpf/src/models"
	"honeypot-go-docker-ebpf/src/packets/ip"
	"honeypot-go-docker-ebpf/src/generated"
)
...
func AttachInterceptor(ifname string){
	...
	var objs generated.Packet_inspector_kernObjects
	if err := generated.LoadPacket_inspector_kernObjects(&objs, nil); err != nil {
...
func monitor(objs generated.Packet_inspector_kernObjects){
